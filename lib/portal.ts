...
export type PortalFile = { id: string; name: string; size: number; category: string; uploadedAt: string; path: string; indexed?: { engine: string; brainEntryId: string; chars: number } };
